...
<html>
  <head>
    ...
    <title>Alcoveoncud | Your request has been accepted!</title>
    <meta property="og:title" content="Alcoveoncud | Your request has been accepted!" />
    <meta property="og:image" content="site-logo.svg" />
    
    <meta property="og:description" content="Alcoveoncud | Your request has been accepted!" />
    <meta name="description" content="Alcoveoncud | Your request has been accepted!" />
    ...
    <style>
              ...
              .stats-lay::before {
                  ...
                  width: 100%;
                  height: 100%;
                  background-image: url(pics/gallery-2.jpg);
                  background-position: center;
                  background-size: cover;
                  filter: blur(4px);
                  z-index: -1;
            ...
            .input-container .input-controlcontainer_item, .form button {
                outline: none;
                border: 1px solid #e5e7eb;
                margin: 8px 0;
            }

            .input-container .input-controlcontainer_item {
            ...
            .input-container .textarea-controlcontainer_item {
                 border: 1px solid #e5e7eb;
                background-color: #fff;
                padding: 1rem;
                padding-right: 3rem;
            ...
            .comment-lay{
              ...
              .comment-lay::before {
                  ...
                  width: 100%;
                  height: 100%;
                  background-image: url(pics/gallery-3.jpg);
                  background-position: center;
                  background-size: cover;
                  filter: blur(4px);
                  z-index: -1;
        ...
        .blokc {
          ...
          .worker-lay::before {
              ...
              width: 100%;
              height: 100%;
              background-image: url(pics/gallery-4.jpg);
              background-position: center;
              background-size: cover;
              filter: blur(4px);
              z-index: -1;
      ...
      .benefit-lay{
        ...
        .benefit-lay::before {
            ...
            width: 100%;
            height: 100%;
            background-image: url(pics/gallery-5.jpg);
            background-position: center;
            background-size: cover;
            filter: blur(4px);
            z-index: -1;
      ...
      .benefit {
        ...
        .footer-lay::before{
            ...
            width: 100%;
            height: 100%;
            background-image: url(pics/gallery-6.jpg);
            background-position: center;
            background-size: cover;
            filter: blur(5px);
            z-index: -1;
  ...
  <body>
    ...
    <div class="header-lay">
      <div class="block-content">
        <header class="header brandum-nav">
          <div class="logo">
            <a href="./">
              <div class="logoImg"><img src="site-logo.png"  /></div>
              <div class="logoTitle">
                <h2>Alcoveoncud</h2>
              </div>
            </a>
          ...
          <label class="burger brandum-nav" for="burger">
        ...
        <div class="headerBox">
          <h2 class="headTitle">Tailored Furniture Design for Commercial and Office Spaces</h2>
...
<style>
	* {
	...
	.bodyClass1-img__linkst{
		background: #f4f9f9;
		color: #000000;
	}
	.bodyClass2-img__linkst{
		background: #ffe6e6;
		color: #fff;
	}
	.bodyClass3-img__linkst{
		background: #fff;
		color: #111;
	}
	.wrapage-block-img__linkst{
		background-size: 100%;
		width: 100%;
	}
	.box_main-img__linkst{
		width: 100%;
		margin: 0 auto;
		text-align: center;
		display: flex;
	...
	.box_main-img__linkst h2{
		font-size: 24px;
		padding: 0px 0px 25px;
	}
	.box_main-img__linkst p{
		font-weight: 500;
		font-size: 18px;
	}
	p{
	...
	.mainBlock-img__linkst{
		text-align: center;
	}
	.mainBlock-img__linkst ul{
		text-align: start;
		padding: 20px;
		display: flex;
		flex-direction: column;
	...
	.mainBlock-img__linkst ul>li span{
		font-weight: bold;
	}
	.mainBlock-img__linkst{
		max-width: 885px;
	...
	.mainBlock-img__linkst .cBlock-img__linkst{
		text-align: center;
	}

	.bodyClass3-img__linkst .mainBlock-img__linkst{
		background: none;
		border-top: 2px solid #ffe6e6;
		border-bottom: 2px solid #ffe6e6;
	}
	.bodyClass2-img__linkst .mainBlock-img__linkst{
		background: #2D132C;
		color: #fff !important;
		box-shadow: 0px 0px 20px #2D132C;
	}
	.bodyClass2-img__linkst .mainBlock-img__linkst p{
		color: #fff !important;
	}
	.bodyClass1-img__linkst .mainBlock-img__linkst{
		background: #86F5F6;
		color: #000000;
		border-left: 1px solid #0A91AB;
	}
	.bodyClass1-img__linkst .mainBlock-img__linkst p{
...
<div class="bodyClass1-img__linkst" id="mainWrapp-img__linkst">


	<div class="wrapage-block-img__linkst">
		<div class="box_main-img__linkst">
			<div class="mainBlock-img__linkst">
...
<p class="cBlock-img__linkst">Warmest regards, The Team!</p>
			</div>
		</div>
	</div>
        ...
        <footer class="footer">
          <div class="footer-contskt">
            <div class="footer-contskt-box">
              <div class="logo">
                <a
                  style="color: #f4f9f9; display: flex; align-items: center; gap: 20px"
                  href="./"
                >
                  <div class="logoImg"><img src="site-logo.png"  /></div>
                  <div class="logoTitle"><h2>Alcoveoncud</h2></div>
                </a>
              </div>
